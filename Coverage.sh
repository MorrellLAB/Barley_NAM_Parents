...
#   List of bam files
BAM_LIST=/panfs/roc/groups/9/morrellp/shared/Projects/Barley_NAM_Parents/SNP_calling/Final_BAMs/Final_BAM_paths.list
#   Directory our bamfiles are located
BAM_DIR=/panfs/roc/groups/9/morrellp/shared/Projects/Barley_NAM_Parents/SNP_calling/Final_BAMs
...
OUT_DIR=/panfs/roc/groups/9/morrellp/shared/Projects/Barley_NAM_Parents/SNP_calling/Coverage
